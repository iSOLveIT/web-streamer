...
Class Details:
    ...
    - Join iSTREAM Class: https://www.istream.cam/join_meeting/v/user_verify?mid={meeting_data['meeting_id']}

NOTE: We emailed the access code for starting class (Class OTP) to the email address provided.
Thank you.
'''
    return msg
...
def disconnect_students(*, room_id):
    ...
    if len(records) != 0:
        ...
        meeting_collection.find_one_and_update({"meeting_id": room_id}, {"$set": {"attendance_records": records}})
...
Class Details:
        ...
        - Join iSTREAM Class: https://www.istream.cam/join_meeting/v/user_verify?mid={email_data['meeting_id']}

NB: Please keep your meeting OTP (One-Time Password) private.
